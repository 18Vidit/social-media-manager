      ...
      <div className="card glass animate-in" style={{ marginBottom: 24 }}>
        ...
        <div style={{
          ...
          {[
            ...
            { name: "→", icon: "", color: "var(--text-muted)" },
            { name: "Copywriter", icon: "", color: "var(--accent-blue)" },
            { name: "→", icon: "", color: "var(--text-muted)" },
            { name: "Guardrail", icon: "", color: "var(--accent-yellow)" },
            { name: "→", icon: "", color: "var(--text-muted)" },
  ...
  return [
    {
      ...
      nodes: [
        ...
        { icon: "", persona: "Caption Generator", status: "completed", detail: "Main LLM call. Inputs: hook, 5 few-shot posts, structural profile, platform rules, banned phrases", why: "Claude Sonnet-class model chosen for tone consistency across long output", duration: "1200ms" },
        { icon: "", persona: "Guardrail Agent", status: "completed", detail: "Voice-drift check: 0.82 (pass). Slop score: 0.05 (pass). Structural match: 0.85 (pass). 3/3 variants passed.", why: "Dual check: embedding similarity catches topical drift, slop rubric catches generic AI writing patterns", duration: "50ms" },
    ...
    },
    {
      ...
      duration: "0.85s",
      nodes: [
        { persona: "Comment Ingestion", status: "completed", detail: "Received 20 new comments from Instagram Graph API", duration: "100ms" },
        { persona: "Sentiment Classifier", status: "completed", detail: "cardiffnlp/twitter-roberta-base-sentiment-latest — classified all 20 comments", why: "Dedicated RoBERTa model, not an LLM call. Citable accuracy: Barbieri et al. 2020", duration: "350ms" },
        { persona: "Intent Classifier", status: "completed", detail: "Classified: 5 FAQ, 5 positive, 3 neutral, 2 collab, 2 complaint, 2 spam, 1 press", duration: "200ms" },
        { persona: "Risk Matrix Router", status: "completed", detail: "2×2 routing: 5 auto-reply, 3 human review, 8 log-only, 2 escalate", why: "Intent confidence × brand risk. Verified accounts auto-bump to high risk.", duration: "20ms" },
        { persona: "Auto-Reply Generator", status: "completed", detail: "Generated 5 on-brand replies for low-risk FAQs. Rate-limited: 5/200 hourly cap.", duration: "180ms" },
        { persona: "Circuit Breaker Check", status: "completed", detail: "Negative ratio: 15% (below 50% trigger). All clear — no posts paused.", why: "Continuous monitoring. If threshold crossed → auto-pause scheduled posts.", duration: "5ms" },
      ],
    },
  ];
}
